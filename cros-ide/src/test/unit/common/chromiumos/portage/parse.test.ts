...
`,
    ...
    },
    {
      ...
      want: new ParsedEbuild([
        ...
        {
          name: name('CROS_WORKON_LOCALNAME', new vscode.Range(12, 0, 12, 21)),
          value: str('platform2', new vscode.Range(12, 23, 12, 32)),
        },
        {
          name: name('CROS_WORKON_DESTDIR_1', new vscode.Range(13, 0, 13, 21)),
          value: str('${S}/platform2', new vscode.Range(13, 23, 13, 37)),
        },
        {
          name: name('CROS_WORKON_SUBTREE', new vscode.Range(14, 0, 14, 19)),
          value: str('common-mk codelab .gn', new vscode.Range(14, 21, 14, 42)),
        },
        {
        ...
        {
          name: name('CROS_WORKON_DESTDIR_2', new vscode.Range(18, 0, 18, 21)),
          value: arr(
            [
              str('${S}/platform/ec', new vscode.Range(19, 3, 19, 19)),
              str('${S}/third_party/cryptoc', new vscode.Range(20, 3, 20, 27)),
